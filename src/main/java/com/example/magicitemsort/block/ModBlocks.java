package com.example.magicitemsort.block;

import java.util.function.Supplier;

import com.example.magicitemsort.MagicItemSort;
import com.example.magicitemsort.items.ModCreativeModeTab;
...
public class ModBlocks{
    ...
    public static final DeferredRegister<Block> BLOCKS = 
        DeferredRegister.create(ForgeRegistries.BLOCKS, MagicItemSort.MODID);
